...
WARNING: 
- running THIS SCRIPT will re-write the PROCEDURE, not run itself
- running the loading PROCEDURE will truncate all Bronze Layer data & reload from Source System
*/
...
/****** Object:  StoredProcedure [bronze].[load_bronze]    Script Date: 9/17/2025 8:18:50 PM ******/
SET ANSI_NULLS ON
GO
